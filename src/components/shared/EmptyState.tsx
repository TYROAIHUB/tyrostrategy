...
export default function EmptyState({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-sm font-semibold text-tyro-text-primary mb-1">{title}</h3>
      <p className="text-xs text-tyro-text-muted text-center max-w-[240px] mb-4">{description}</p>
      {action}
    </motion.div>
  );
}
